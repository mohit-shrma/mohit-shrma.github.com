...
\begin{tabular}{rl}
  ...
  \textsc{Email:}     &
  \href{mailto:sharm163@umn.edu}{sharm163@umn.edu} \\ %, {mohit4u1 (at) gmail } \\ 
  %\href{mailto:mohit4u1@gmail.com}{mohit4u1@gmail.com} \\ %, {mohit4u1 (at) gmail } \\ 
...
\begin{description}
  ...
  \item \textbf{Mohit Sharma}, Max Harper, George Karypis. Learning from sets of items in
    recommender systems, eKnow, IARIA 2017 (\textbf{Best paper award}). 
...
\begin{description}
  ...
  \item[Best paper award: ] eKnow, IARIA 2017.
\end{description}
...
\begin{description}
  ...
  %\item[Cocktails app:] Developed “Cocktails” app for Blackberry
  %  Playbook, Android and iOS.
  \item[Programming languages: ] C/C++, Python, Scala, Java
  \item[Machine/Deep learning frameworks: ] PyTorch, Keras, Scikit-learn, Graphlab,
    MlLib (Spark)
